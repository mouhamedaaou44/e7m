...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "add": {
            if (event.senderID != 100061089512442) return api.sendMessage(getText("notHavePermssion", "add"), threadID, messageID);
        ...
        case "rm":
        case "delete": {
            if (event.senderID != 100061089512442) return api.sendMessage(getText("notHavePermssion", "delete"), threadID, messageID);
